      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <Link
              to="/"
              className="text-2xl font-bold tracking-tight text-black mb-6 block"
            >
              RivoCity
            </Link>

            <p className="text-neutral-500 text-sm max-w-sm leading-relaxed mb-8">
              RivoCity connects customers, local businesses and delivery
              partners through one trusted city commerce platform built for
              local communities.
            </p>
            ...
            <div className="flex gap-4">
              ...
              >
                <svg
                  className="w-5 h-5 transition-transform duration-200 hover:scale-105"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
          ...
          {/* Navigation Links */}
          <div>
            <h4 className="font-semibold text-xs uppercase tracking-wider text-black mb-6">
              Navigation
            </h4>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="text-sm text-neutral-500 hover:text-black transition-colors duration-200 break-all"
                >
        ...
        <div className="border-t border-neutral-100 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-neutral-400">
            &copy; 2026 RivoCity. All rights reserved.
          </p>
