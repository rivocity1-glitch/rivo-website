          ...
          <div className="container-custom">
            ...
            >
              ...
              >
                ...
                <p className="mt-5 text-brand-gray-muted leading-relaxed">
                  Choose the app you need and scan its QR code to download the
                  Android APK.
                </p>
              </motion.div>
              ...
              <motion.div
                variants={staggerContainer}
                className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-14 max-w-5xl mx-auto"
              >
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-primary/10 text-brand-primary text-xs font-semibold mb-4">
                    ...
                    <p className="text-sm text-brand-gray-muted mt-2 max-w-sm">
                      Shop from local stores, place orders and follow your
                      deliveries.
                    </p>
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-sm text-brand-gray-muted mt-2 max-w-sm">
                      Manage assigned deliveries, pickups, deliveries and
                      rider earnings.
                    </p>
